...
class DataAntrianIsiDokter extends StatefulWidget {
  DataAntrianIsiDokter({Key? key, required this.tf}) : super(key: key);
  Map tf;

  @override
  State<DataAntrianIsiDokter> createState() => _DataAntrianIsiDokterState(this.tf);
}

class _DataAntrianIsiDokterState extends State<DataAntrianIsiDokter> {
  _DataAntrianIsiDokterState(this.tf);
  late Map tf;
    ...
    return Scaffold(
        ...
        Column(
          children: [
            ...
            Center(child: Text('Hasil Pemeriksaan Pasien',style: GoogleFonts.nunito(fontSize: 30,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)),
                ...
                child: Container(
                    ...
                    child: ListView(
                      ...
                      children:<Widget>[
                        ...
                        TextFieldWidget(
                          //'E-mail',idx['jenis_layanan'], Icons.mail_outline),
                            'Nama Pasien','${tf["pasien"]['name']}', Icons.person),

                        TextFieldWidget(
                          //'E-mail',idx['jenis_layanan'], Icons.mail_outline),
                            'Tanggal Lahir','${tf["pasien"]["tgl_lahir"]}', Icons.baby_changing_station),

                        TextFieldWidget(
                          //'E-mail',idx['jenis_layanan'], Icons.mail_outline),
                            'Alamat','${tf["pasien"]["alamat"]}', Icons.location_on),

                        TextFieldWidget(
                          //'E-mail',idx['jenis_layanan'], Icons.mail_outline),
                            'Jenis Kelamin','${tf["pasien"]["jenis_kelamin"]}', Icons.man),

                        TextFieldWidget(
                          //'E-mail',idx['jenis_layanan'], Icons.mail_outline),
                            'Agama','${tf["pasien"]["agama"]}', Icons.mosque),

                        TextFieldWidget(
                          //'E-mail',idx['jenis_layanan'], Icons.mail_outline),
                            'Pekerjaan','${tf["pasien"]["pekerjaan"]}', Icons.work),
                                ...
                                onPressed: (){
                                  ...
                                  if(_formKey.currentState!.validate()){
                                    Provider.of<Auth>(context, listen: false)
                                        .updateRekaman(creds:creds,id: tf["id"]);
