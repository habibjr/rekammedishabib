...
class IsiDataPasienRevisi extends StatefulWidget {
  const IsiDataPasienRevisi({Key? key}) : super(key: key);

  @override
  State<IsiDataPasienRevisi> createState() => _IsiDataPasienRevisiState();
}

class _IsiDataPasienRevisiState extends State<IsiDataPasienRevisi> {
        ...
        appBar: AppBar(
          ...
          title:Row(
            children: [
              ...
              SizedBox(width: 9,),
              Text('Isi Data Pasien',style: GoogleFonts.nunito(color: Colors.white)),
              Spacer(),
              IconButton(
                  onPressed: (){
